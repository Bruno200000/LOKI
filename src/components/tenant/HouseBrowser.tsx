...
export const HouseBrowser: React.FC = () => {
  ...
  const [placeholderText, setPlaceholderText] = useState('Quartier, ville, titre...');
  ...
  useEffect(() => {
    const phrases = ["Quartier, ville, titre...", "Grand Appartement...", "Villa avec piscine...", "Terrain idéal..."];
    let phraseIndex = 0;
    let charIndex = 0;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-0 pb-20">
          {filteredHouses.map((house, index) => (
            <div
              ...
              className="group bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_45px_rgb(113,128,150,0.1)] border border-slate-100/80 overflow-hidden transition-all duration-500 cursor-pointer animate-slide-up hover:-translate-y-2"
